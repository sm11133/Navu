...
# App Setup
# ----------------------------
st.set_page_config(page_title="📤 Google Drive Uploader", page_icon="📁")
st.title("📁 Upload File to Google Drive")

SCOPES = ["https://www.googleapis.com/auth/drive.file"]
TOKEN_FILE = "token.pickle"
FOLDER_ID = "1lVsJ3-CjtgKaAyBszmaDWEC6MaOVpZwV"  # ← अपनी Drive Folder ID डालें
